...
module.exports = function (app) {
  ...
  app
    ...
    .post(index.requiresLogin, index.isPatient, Alert.create);
  ...
  app
    ...
    .get(Alert.read)
    .put(index.requiresLogin, Alert.hasAuthorization, Alert.update)
    .delete(index.requiresLogin, Alert.hasAuthorization, Alert.delete);
